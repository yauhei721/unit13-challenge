...
def validate_data(age, invest_amount, intent_request):
    ...
    # Validate that the user is over 0 but less than 65 years old
    if age is not None:
        if parse_float(age) < 0 or parse_float(age) > 65:
    ...
    if invest_amount is not None:
        ...
        if invest_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The amount to convert should be greater than CAD 5000, "
